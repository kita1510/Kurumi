<h1 align='center'>Vite + React + TypeScript + Eslint + Prettier + Tailwind Template ⚡</h1>

Create a new project with Vite, React JS, TypeScript, Eslint, Prettier, tailwind in just 1 second and you don't need to setup anything.
